    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.CompareToConstant9_const
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(19)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.aqcv0jubph
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.ozu2y31dtq
                    section.data(2).logicalSrcIdx = 4;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.inucnhth2x
                    section.data(3).logicalSrcIdx = 5;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.nny3v2xf2q
                    section.data(4).logicalSrcIdx = 6;
                    section.data(4).dtTransOffset = 3;

                    ;% ntrh2fpvwnc.jiop5zkdop
                    section.data(5).logicalSrcIdx = 7;
                    section.data(5).dtTransOffset = 4;

                    ;% ntrh2fpvwnc.npk1xnhbt1
                    section.data(6).logicalSrcIdx = 8;
                    section.data(6).dtTransOffset = 5;

                    ;% ntrh2fpvwnc.pomc5q5r3o
                    section.data(7).logicalSrcIdx = 9;
                    section.data(7).dtTransOffset = 6;

                    ;% ntrh2fpvwnc.p5bp5zhs5q
                    section.data(8).logicalSrcIdx = 10;
                    section.data(8).dtTransOffset = 7;

                    ;% ntrh2fpvwnc.lnfyc4bs4f
                    section.data(9).logicalSrcIdx = 11;
                    section.data(9).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.jwp32ymkon
                    section.data(10).logicalSrcIdx = 12;
                    section.data(10).dtTransOffset = 9;

                    ;% ntrh2fpvwnc.iejz3yh1lu
                    section.data(11).logicalSrcIdx = 13;
                    section.data(11).dtTransOffset = 10;

                    ;% ntrh2fpvwnc.opdhoi1kjz
                    section.data(12).logicalSrcIdx = 14;
                    section.data(12).dtTransOffset = 2210;

                    ;% ntrh2fpvwnc.dll0ery5xq
                    section.data(13).logicalSrcIdx = 15;
                    section.data(13).dtTransOffset = 4410;

                    ;% ntrh2fpvwnc.kqg4jrmhje
                    section.data(14).logicalSrcIdx = 16;
                    section.data(14).dtTransOffset = 6610;

                    ;% ntrh2fpvwnc.mujbc3qedi
                    section.data(15).logicalSrcIdx = 17;
                    section.data(15).dtTransOffset = 8610;

                    ;% ntrh2fpvwnc.jpzbni32qe
                    section.data(16).logicalSrcIdx = 18;
                    section.data(16).dtTransOffset = 10610;

                    ;% ntrh2fpvwnc.dm2g45kqd2
                    section.data(17).logicalSrcIdx = 19;
                    section.data(17).dtTransOffset = 12610;

                    ;% ntrh2fpvwnc.ja4sqsk45s
                    section.data(18).logicalSrcIdx = 20;
                    section.data(18).dtTransOffset = 14810;

                    ;% ntrh2fpvwnc.pzrewnrcb2
                    section.data(19).logicalSrcIdx = 21;
                    section.data(19).dtTransOffset = 17010;
            ...
            section.data(11)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.cvjxunlkmb
                    section.data(1).logicalSrcIdx = 22;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.e5xh42fcf3
                    section.data(2).logicalSrcIdx = 23;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.m4d4q4le0e
                    section.data(3).logicalSrcIdx = 24;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.jem13mkjx5
                    section.data(4).logicalSrcIdx = 25;
                    section.data(4).dtTransOffset = 3;

                    ;% ntrh2fpvwnc.nddqd0c4sp
                    section.data(5).logicalSrcIdx = 26;
                    section.data(5).dtTransOffset = 4;

                    ;% ntrh2fpvwnc.le3kursc2a
                    section.data(6).logicalSrcIdx = 27;
                    section.data(6).dtTransOffset = 5;

                    ;% ntrh2fpvwnc.lgh2vrhjl3
                    section.data(7).logicalSrcIdx = 28;
                    section.data(7).dtTransOffset = 6;

                    ;% ntrh2fpvwnc.algpajr0pa
                    section.data(8).logicalSrcIdx = 29;
                    section.data(8).dtTransOffset = 7;

                    ;% ntrh2fpvwnc.jnlj5ankez
                    section.data(9).logicalSrcIdx = 30;
                    section.data(9).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.jxxwwrzsly
                    section.data(10).logicalSrcIdx = 32;
                    section.data(10).dtTransOffset = 9;

                    ;% ntrh2fpvwnc.c5pjuksat0
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.jyiz51obdd
                    section.data(5).logicalSrcIdx = 39;
                    section.data(5).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.fxgka2mnesn.i42mdibeor
                    section.data(6).logicalSrcIdx = 40;
                    section.data(6).dtTransOffset = 9;

                    ;% ntrh2fpvwnc.fxgka2mnesn.n05ugjqijp
                    section.data(7).logicalSrcIdx = 41;
                    section.data(7).dtTransOffset = 10;

                    ;% ntrh2fpvwnc.fxgka2mnesn.iolkzzata4
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(16)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.iwa1izldp3
                    section.data(12).logicalSrcIdx = 15;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.onx5vrar2j
                    section.data(13).logicalSrcIdx = 16;
                    section.data(13).dtTransOffset = 12;

                    ;% cjyyyt0pe2y.f5w2qap0xd
                    section.data(14).logicalSrcIdx = 17;
                    section.data(14).dtTransOffset = 13;

                    ;% cjyyyt0pe2y.gtvwvkz4ct
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.a0ydqk0kso
                    section.data(5).logicalSrcIdx = 25;
                    section.data(5).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.knvhwgd45a
                    section.data(6).logicalSrcIdx = 26;
                    section.data(6).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.amitdmh40w
                    section.data(7).logicalSrcIdx = 27;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.bedhay20g3
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ll3prxm0ly
                    section.data(3).logicalSrcIdx = 64;
                    section.data(3).dtTransOffset = 2;
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.cshdnrznlk
                    section.data(1).logicalSrcIdx = 66;
                    section.data(1).dtTransOffset = 0;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.i420tlx0ig
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.hcslzq30jn
    ...
    targMap.checksum0 = 614928365;
    targMap.checksum1 = 229266955;
    targMap.checksum2 = 1959600297;
    targMap.checksum3 = 3395185854;
